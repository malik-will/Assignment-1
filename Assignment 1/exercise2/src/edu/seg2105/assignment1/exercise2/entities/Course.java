...
public class Course {
    ...
    // The teaching assistant teaching the course
     ...
     */
    public void setTeachingAsssistant(TeachingAssistant teachingAssistant) {
    ...
    private String getTeachingAssistantName(){
        return teachingAssistant != null ? teachingAssistant.getFirstName() + " " + teachingAssistant.getLastName() : "Not yet assigned";
    }
    ...
    public String toString() {
        return "Course information:\n"
                ...
                + "\tTeaching Assistant: "+ getTeachingAssistantName() + "\n"
